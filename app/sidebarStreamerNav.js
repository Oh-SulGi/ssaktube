		...
		<div className={styles.channels}>
			...
			<ul className={styles.streamers}>
				{test_streamers.map((streamer) => (
					<li className={styles.streamer} key={streamer.streamerName}>
						<Image className={styles.streamLogo} src={streamer.streamerIcon} width={28} height={28} alt='스트리머 아이콘'></Image>
						{isOpen ? (
							<>
